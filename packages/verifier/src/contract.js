...
export function derivePortableResultContract(result) {
  ...
  return {
    ...
    trust_input: {
      class: result.checks.trust_input_class,
      source: result.checks.issuer_trust_source,
      bundle_id: result.checks.trust_bundle_id,
      bundle_version: result.checks.trust_bundle_version,
      bundle_status: result.checks.trust_bundle_status,
      bundle_scope: result.checks.trust_bundle_scope
    },
    must_preserve_fields: [
      "checks.issuer_trust_status",
      "checks.issuer_trust_source",
      "checks.trust_input_class",
      "checks.trust_bundle_id",
      "checks.trust_bundle_version",
      "checks.trust_bundle_status",
      "checks.trust_bundle_scope",
      "checks.signing_key_purpose_status",
      "checks.signing_key_purpose_reasons",
      "checks.signing_key_event_time_status",
      "checks.signing_key_event_time_reasons",
      "checks.signing_key_current_time_status",
      "checks.signing_key_current_time_reasons",
      "checks.signing_key_revocation_event_time_status",
      "checks.signing_key_revocation_current_time_status",
      "checks.signing_key_revocation_effective_at",
      "checks.owner_binding_status",
      "checks.owner_binding_reasons",
      "checks.key_binding_status",
      "checks.key_binding_method",
      "checks.key_binding_reasons",
      "checks.key_authorization_status",
      "checks.key_authorization_object_id",
      "checks.key_authorization_reasons",
    ...
    checks: {
      ...
      signing_key_status: result.checks.signing_key_status,
      signing_key_purpose_status: result.checks.signing_key_purpose_status,
      signing_key_purpose_reasons: result.checks.signing_key_purpose_reasons,
      signing_key_event_time_status: result.checks.signing_key_event_time_status,
      signing_key_event_time_reasons: result.checks.signing_key_event_time_reasons,
      signing_key_current_time_status: result.checks.signing_key_current_time_status,
      signing_key_current_time_reasons: result.checks.signing_key_current_time_reasons,
      signing_key_revocation_event_time_status: result.checks.signing_key_revocation_event_time_status,
      signing_key_revocation_current_time_status: result.checks.signing_key_revocation_current_time_status,
      signing_key_revocation_effective_at: result.checks.signing_key_revocation_effective_at,
      digest_algorithms: result.checks.digest_algorithms,
      issuer_trust_status: result.checks.issuer_trust_status,
      issuer_trust_source: result.checks.issuer_trust_source,
      trust_input_class: result.checks.trust_input_class,
      trust_bundle_id: result.checks.trust_bundle_id,
      trust_bundle_version: result.checks.trust_bundle_version,
      trust_bundle_status: result.checks.trust_bundle_status,
      trust_bundle_scope: result.checks.trust_bundle_scope,
      owner_binding_status: result.checks.owner_binding_status,
      owner_binding_reasons: result.checks.owner_binding_reasons,
      key_binding_status: result.checks.key_binding_status,
      key_binding_method: result.checks.key_binding_method,
      key_binding_reasons: result.checks.key_binding_reasons,
      key_authorization_status: result.checks.key_authorization_status,
      key_authorization_object_id: result.checks.key_authorization_object_id,
      key_authorization_reasons: result.checks.key_authorization_reasons,
